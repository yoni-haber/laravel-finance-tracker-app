<div class="space-y-6">
    <div class="rounded-xl border border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <form wire:submit.prevent="save" class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
                <label
                    class="block text-xs font-semibold uppercase tracking-wide text-gray-900 dark:text-white">Month</label>
            ...
            <div>
                <label
                    class="block text-xs font-semibold uppercase tracking-wide text-gray-900 dark:text-white">Year</label>
                ...
                @forelse ($budgets as $budget)
                    <tr>
                        ...
                        <td class="px-3 py-2 text-right space-x-2">
                            <button type="button" wire:click="edit({{ $budget->id }})" class="text-sm text-blue-600">
                                Edit
                            </button>
                            <button type="button" wire:click="delete({{ $budget->id }})" class="text-sm text-rose-600">
                                Delete
                            </button>
                        </td>
                    </tr>
